	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			<DialogTrigger asChild>
				<Button variant="outline" className="p-0 h-auto font-normal">
					Sign up
				</Button>
			</DialogTrigger>
			<DialogContent className="sm:max-w-[600px]">
				...
				<div className="mt-4">
					<p className="text-lg text-muted-foreground">
						Connect with a Legal AI Expert for a live, no-nonsense demo. See
						firsthand how our tools can transform your workflow
					</p>
				</div>
				<Form {...form}>
					<form
